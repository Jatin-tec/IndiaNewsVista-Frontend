            ...
            <div className='col-lg-8'>
              <div className='position-relative mb-3'>
                ...
                <div className='bg-white border border-top-0 p-4'>
                  <div className='mb-3'>
                    <a className='badge badge-primary text-uppercase text-bg-warning p-3 font-weight-semi-bold p-2 mr-2' href='/'>
                      {news.category}
                    </a>
                    <a className='text-body p-3' href='/' style={{ textDecoration: 'none' }}>
                      {news.published_at}
                    </a>
                  </div>
                  <h1 className='mb-3 text-secondary text-uppercase font-weight-bold'>{news.title}</h1>
                  ...
                  <p>
                    ...
                    sadipscing gubergren erat. Gubergren at lorem invidunt sadipscing rebum sit amet ut ut, voluptua diam dolores at
                    sadipscing stet. Clita dolor amet dolor ipsum vero ea ea eos. Invidunt sed diam dolores takimata dolor dolore dolore
                    sit. Sit ipsum erat amet lorem et, magna sea at sed et eos. Accusam eirmod kasd lorem clita sanctus ut consetetur et. Et
                  ...
                  <p>
                    ...
                    sadipscing stet. Clita dolor amet dolor ipsum vero ea ea eos. Invidunt sed diam dolores takimata dolor dolore dolore
                    sit. Sit ipsum erat amet lorem et, magna sea at sed et eos. Accusam eirmod kasd lorem clita sanctus ut consetetur et. Et
                    duo tempor sea kasd clita ipsum et. Takimata kasd diam justo est eos erat aliquyam et ut.
                  </p>
                </div>
                <div className='d-flex justify-content-between bg-white border border-top-0 p-4'>
                  ...
                  <div className='d-flex align-items-center'>
                    <small className='ml-3 px-2'>
                      <FontAwesomeIcon className='far fa-eye mr-2 ' icon={faEye} /> 1234
                    </small>
                ...
                <div className='bg-white border border-top-0 p-4'>
                  <div className='media mb-4'>
                    ...
                    <div className='media-body'>
                      <h6>
                        <a className='text-secondary font-weight-bold mt-2' href='/' style={{ textDecoration: 'none' }}>
                          John Doe
                        </a>{' '}
                      ...
                      <p>
                        Diam amet duo labore stet elitr invidunt ea clita ipsum voluptua, tempor labore accusam ipsum et no at. Kasd diam
                  ...
                  <div className='media'>
                    ...
                    <div className='media-body'>
                      <h6>
                        <a className='text-secondary font-weight-bold' href='/' style={{ textDecoration: 'none' }}>
                          John Doe
                        </a>{' '}
                        <small className='px-2'>
                          <i>01 Jan 2045</i>
                      ...
                      <div className='media mt-4'>
                        ...
                        <div className='media-body'>
                          ...
                          <p>
                            Diam amet duo labore stet elitr invidunt ea clita ipsum voluptua, tempor labore accusam ipsum et no at. Kasd
                  ...
                  <form>
                    <div className='form-row'>
                      <div className='col-sm-6'>
                        <div className='form-group mb-2'>
                          <label htmlFor='name' className='mb-2 p-2' style={{ color: '#838383', fontWeight: 'bold', fontSize: '22px' }}>
                            Name *
                          </label>
                      ...
                      <div className='col-sm-6'>
                        <div className='form-group'>
                          <label htmlFor='email' className='mb-2 p-1' style={{ color: '#838383', fontWeight: 'bold', fontSize: '22px' }}>
                            Email *
                          </label>
                    ...
                    <div className='form-group'>
                      <label
                        ...
                        style={{ color: '#838383', fontWeight: 'bold', fontSize: '22px' }}
                      >
                        Website
                      </label>
                    ...
                    <div className='form-group'>
                      <label htmlFor='message' className='mt-2 mb-2 p-1' style={{ color: '#838383', fontWeight: 'bold', fontSize: '22px' }}>
                        Message *
                      </label>
                      <textarea id='message' cols='30' rows='8' className='form-control'></textarea>
                    </div>
                    <div className='form-group mb-0'>
                      <input type='submit' value='Leave a comment' className='btn bg-warning font-weight-semi-bold py-2 px-3 mt-3' />
                    </div>
                  </form>
                </div>
              </div>
