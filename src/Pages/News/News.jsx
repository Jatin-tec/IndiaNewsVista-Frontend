...
function News() {
  ...
  useEffect(() => {
    ;(async () => {
      ...
      const response = await axios.get('http://localhost:8000/news/get-all-news/2')
                    ...
                    return (
                      <>
                        <NewsBlock
                          ...
                          image={img1}
                          image2={user}
                          eventOn={handleMouseEnter}
                          eventOff={handleMouseLeave}
                          style={textStyle}
                        />
                        {(key + 1) / 2 === 1 ? (
                          <div className='col-lg-12 mb-3'>
                            <a href='/'>
                              <img className='img-fluid w-100' src={ad} alt='' />
                            </a>
                          </div>
                        ) : (
                          ''
                  ...
                  <div className='row news-lg mx-0 mb-3'>
                    ...
                    <div className='col-md-6 d-flex flex-column border bg-white h-100 px-0'>
                      <div className='mt-auto p-4'>
                        <div className='mb-2'>
                          <a
                            className='text-bg-warning text-uppercase font-weight-semi-bold p-2 mr-2'
                            href='/'
                            style={{ 'text-decoration': 'none' }}
                          >
                            Business
                          </a>
                          <a className='text-body' href='/' style={{ 'text-decoration': 'none' }}>
                            <small onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} style={textStyle} className='px-2'>
                              Jan 01, 2045
                            </small>
                          </a>
                        </div>
