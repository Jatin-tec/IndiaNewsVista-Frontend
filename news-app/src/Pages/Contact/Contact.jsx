            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="section-title mb-0">
                        <h4 class="m-0 text-uppercase text-bg-warning p-3 font-weight-bold">Contact Us For Any Queries</h4>
                    </div>
                    <div class="bg-white border border-top-0 p-4 mb-0 mt-4">
                        <div class="mb-4">
                            <h5 class="text-uppercase font-weight-bold" >Contact Info</h5>
                            <p class="mb-4 font-weight-4px">The contact form is currently inactive. Get a functional and working contact form with Ajax & PHP in a few minutes. Just copy and paste the files, add a little code and you're done. <a className='text-warning' href="https://htmlcodex.com/contact-form">Download Now</a>.</p>
							<div class="mb-0">
                                <div class="d-flex align-items-center mb-2">
                                <FontAwesomeIcon icon={faMapMarkerAlt} className='px-2 text-warning' size="1x" />
                                    <h5 class="font-weight-bold mb-0">Our Office</h5>
                                </div>
                                <p class="m-0 pb-5">123 Street, New York, USA</p>
                            </div>
                            <div class="mb-0">
                                <div class="d-flex align-items-center mb-2">
                                <FontAwesomeIcon icon={faEnvelope}  className='px-2 text-warning' size="1x" />
                                    <h5 class="font-weight-bold  mb-0">Email Us</h5>
                                </div>
                                <p class="m-0 pb-5">info@example.com</p>
                            </div>
                            <div class="mb-0">
                                <div class="d-flex align-items-center mb-2">
                                <FontAwesomeIcon icon={faPhone} className='px-2 text-warning' size="1x" />
                                    <h5 class="font-weight-bold mb-0">Call Us</h5>
                                </div>
                                <p class="m-0 pb-5">+012 345 6789</p>
                            
                        
                        <h5 class="text-uppercase font-weight-bold  mb-0">Contact Us</h5>
                        <form>
                            <div class="form-row">
                            ...
                            <div class="form-group mb-5">
                                <textarea class="form-control" rows="7" placeholder="Message" required="required"></textarea>
                                <button class="btn bg-warning font-weight-semi-bold mt-3 px-4 mt-0" style={{"height": "50px"}}
