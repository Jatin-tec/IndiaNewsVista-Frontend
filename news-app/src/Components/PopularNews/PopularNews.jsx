    ...
    <>
      <div className="d-flex align-items-center bg-white mb-3" style={{"height": "110px"}}>
                                ...
                                <div className="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                    <div className="mb-2">
                                        <a className="badge text-bg-warning p-2 text-uppercase font-weight-semi-bold p-1 mr-2" href="/" style={{"text-decoration" : "none"}}>{props.category}</a>
                                        <a className="text-body px-2" href="/" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}  style={{"text-decoration" : "none", ...textStyle}} ><small  >{props.date}</small></a>
                                    </div>
